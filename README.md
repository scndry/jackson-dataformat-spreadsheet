...
- [DESIGN.md](DESIGN.md) — Design philosophy and abstraction boundaries
...
Yes. Version 1.3.2 on Maven Central. Java 8+, Jackson 2.14+, POI 4.1.1+. Listed as a [community data format module](https://github.com/FasterXML/jackson#data-format-modules) in the FasterXML jackson repository.
